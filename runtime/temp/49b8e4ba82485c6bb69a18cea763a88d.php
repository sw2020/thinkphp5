...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;" onclick="member_add('添加用户','<?php echo url("Vip/addpage"); ?>','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加用户</a></span> <span class="r">共有数据：<strong><?php echo count($vips) ?></strong> 条</span> </div>
			<div class="mt-20">
				<table class="table table-border table-bordered table-hover table-bg table-sort">
					...
					<tbody>
					<?php if(is_array($vips) || $vips instanceof \think\Collection || $vips instanceof \think\Paginator): $i = 0; $__LIST__ = $vips;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
						<tr class="text-c">
							<td><input type="checkbox" value="1" name=""></td>
							<td><?php echo $vo['id']; ?></td>
							<td><u style="cursor:pointer" class="text-primary" onclick="member_show('<?php echo $vo['username']; ?>','<?php echo url("Vip/show",['id'=>$vo['id']]); ?>','<?php echo $vo['id']; ?>','540','600')"><?php echo $vo['username']; ?></u></td>
							<td><?php echo $vo['vip']; ?></td>
							<td>
							<?php if($vo['vipend'] == null || $vo['vipend'] == ''): ?>暂未开通会员服务<?php else: ?>
							<?php echo date("Y-m-d",$vo['vipend']); endif; ?></td>
							<td><?php echo $vo['sex']; ?></td>
							<td><?php echo $vo['phone']; ?></td>
							<td><?php echo $vo['email']; ?></td>
							<td class="text-l"><?php if(($vo['address'] == '' || $vo['address']==null)): ?>暂无相关信息<?php else: ?><?php echo $vo['address']; endif; ?></td>
							<td><?php echo $vo['create_time']; ?></td>
							<td class="td-status"><span class="label label-success radius">已启用</span></td>
							<td class="td-manage">
								<a style="text-decoration:none" onClick="member_stop(this,'10001')" href="javascript:;" title="停用"><i class="Hui-iconfont">&#xe631;</i></a> 
								<a title="编辑" href="javascript:;" onclick="member_edit('编辑','<?php echo url("Vip/editPage",["id"=>$vo['id']]); ?>','4','','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> 
								<a style="text-decoration:none" class="ml-5" onClick="change_password('修改密码','<?php echo url("Vip/changePass",["id"=>$vo['id']]); ?>','10001','600','270')" href="javascript:;" title="修改密码"><i class="Hui-iconfont">&#xe63f;</i></a> 
...
function member_del(obj,id){
	layer.confirm('确认要删除吗？',function(index){
		$.post("<?php echo url('Vip/del'); ?>",{'id':id},function(data){
			if(data.status == 1){
