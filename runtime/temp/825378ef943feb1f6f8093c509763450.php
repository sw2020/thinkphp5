<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:93:"E:\project\workspace\thinkphp5\public/../application/admin\view\AdminRole\admin-role-add.html";i:1507878124;s:80:"E:\project\workspace\thinkphp5\public/../application/admin\view\public\meta.html";i:1504605462;s:82:"E:\project\workspace\thinkphp5\public/../application/admin\view\public\footer.html";i:1504578213;}*/ ?>
﻿<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
$(function(){
	...
	$("#admin-role-save").on('click',function(){
		...
		$.ajax({
			type:"POST",
			url:"<?php echo url('AdminRole/addRole'); ?>",
