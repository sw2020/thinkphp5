	...
	<form action="" method="post" class="form form-horizontal" id="form-admin-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<input type="text" class="input-text" value="" placeholder="<?php echo $user['name']; ?>" id="adminName" name="name">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="<?php echo $user['phone']; ?>" id="phone" name="phone">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>邮箱：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" placeholder="<?php echo $user['email']; ?>" name="email" id="email">
			</div>
		</div>
		<div class="row cl">
...
$(function(){
	...
	$(".radius").on("click",function(){
		$.ajax({
			type:"POST",
			url:"<?php echo url('User/editAdmin'); ?>",
