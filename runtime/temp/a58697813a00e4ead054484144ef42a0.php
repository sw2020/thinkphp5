		...
		$.ajax({
			...
			success:function(data){
				if(data.status == 1 ){
					...
					setTimeout(function(){
						 //刷新页面
				        parent.window.location.href='<?php echo url("Article/main"); ?>';
				        //获取窗口索引
