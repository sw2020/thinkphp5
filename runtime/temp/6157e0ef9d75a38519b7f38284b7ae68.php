...
<article class="cl pd-20">
	<form action="/" method="post" class="form form-horizontal" id="form-change-password">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> <?php echo $vip['username']; ?> </div>
...
$(function(){
	...
	$('.radius').on('click',function(){
		$.post('<?php echo url("Vip/password"); ?>',$("#form-change-password").serialize(),function(data){
			if(data.status == 1 ){
