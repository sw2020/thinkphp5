    ...
    <div class="am-u-md-8 am-u-sm-12">
      <article class="am-article blog-article-p">
        <div class="am-article-hd">
          <h1 class="am-article-title blog-text-center"><?php echo $article['titel']; ?></h1>
          <p class="am-article-meta blog-text-center">
              <span><a href="#" class="blog-color">article &nbsp;</a></span>-
              <span><a href="#">@<?php echo $article['author']; ?> &nbsp;</a></span>-
              <span><a href="#"><?php echo $article['create_time']; ?> &nbsp;</a></span>
              <span><a href="#">浏览次数：<?php echo $article['glance']; ?></a></span>
          </p>
        </div>        
        ...
        摘要：
        <blockquote><p><?php echo $article['about']; ?></p> <footer><?php echo $article['small_title']; ?></footer></blockquote>
        ...
        <div class="am-g blog-author blog-article-margin">
          ...
          <h3><span>作者 &nbsp;: &nbsp;</span><span class="blog-color"><?php echo $article['author']; ?></span></h3>
            <p><?php if($user['beizhu'] == null || $user['beizhu'] == ''): ?>这个家伙很懒，什么也没留下！<?php else: ?><?php echo $user['beizhu']; endif; ?></p>
          </div>
        </div>
        <hr>
        ...
        <hr>
         <?php if(is_array($reviews) || $reviews instanceof \think\Collection || $reviews instanceof \think\Paginator): $i = 0; $__LIST__ = $reviews;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
         	 <div class="am-g blog-author blog-article-margin">
		         ...
		         <div class="am-u-sm-9 am-u-md-9 am-u-lg-10">
		         <h3><span>留言者 &nbsp;: &nbsp;<?php if($vo['username'] == null || $vo['username']=''): ?>博客用户<?php echo $vo['uid']; else: ?><?php echo $vo['username']; endif; ?></span><span class="blog-color"> &nbsp;<?php echo $vo['sex']; ?></span></h3>
