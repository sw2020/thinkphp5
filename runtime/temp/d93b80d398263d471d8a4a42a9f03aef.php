...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			<div class="cl pd-5 bg-1 bk-gray"> <span class="l"> <a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" href="javascript:;" onclick="admin_role_add('添加角色','addRolePage','800')"><i class="Hui-iconfont">&#xe600;</i> 添加角色</a> </span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
			<div class="mt-10">
			<table class="table table-border table-bordered table-hover table-bg">
				...
				<tbody>
					...
					<tr class="text-c">
						...
						<td>
							<?php 
								foreach( $vo['permissionid'] as $perid ){
									echo $perid[0];
									if($perid[1] == 1){
										echo "增加 ";
									}elseif($perid[1] == 2){
						...
						<td class="f-14"><a title="编辑" href="#" onclick="admin_role_edit('角色编辑','<?php echo url("AdminRole/editRolePage",["id"=>$vo['id']]); ?>','<?php echo $vo['id']; ?>')" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> <a title="删除" href="javascript:;" onclick="admin_role_del(this,'<?php echo $vo['id']; ?>')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
					</tr>
...
function admin_role_del(obj,id){
	layer.confirm('角色删除须谨慎，确认要删除吗？',function(index){
		...
		$.post("<?php echo url('AdminRole/delRole'); ?>",{Rid:id},function(data){
			if(data.status == 1){
