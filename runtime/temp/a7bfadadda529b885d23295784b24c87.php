<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"E:\project\workspace\thinkphp5\public/../application/admin\view\User\login.html";i:1510885801;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
			...
			$.ajax({
				...
				success:function(data){
					if(data.status == 1){
						...
						alert(data.message);
						window.location="<?php echo url('admin/User/login'); ?>";
					}
				}
			});		
		});
